...
# installed.
TCL_PREFIX='H:/katomaran/vrg\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='H:/katomaran/vrg\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='H:/katomaran/vrg\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IH:/katomaran/vrg\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LH:/katomaran/vrg\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='H:/katomaran/vrg\Library\lib\tclstub86.lib'
